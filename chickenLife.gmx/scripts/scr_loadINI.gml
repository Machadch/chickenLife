if (file_exists("save.ini")) {
    ...
    for (i = 0; i < chickenSpawn; i++) {
        scr_chickenSpawner(ini_read_real("Chicken","hunger",250),ini_read_real("Chicken","thirst",250),ini_read_real("Chicken","layDate",0),ini_read_string("Chicken","location","yard"));
    }
